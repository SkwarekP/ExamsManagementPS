...
export const Form = ({ exam }: Props) => {
  ...
  const { data: examData, isLoading } = useFetchAnswersByExamIdQuery({
    examId: exam?.examId,
  });
  ...
  return (
    <div className={classes.wrapper}>
      <div className={classes.header}>
        ...
        <span>
          Congratulations, you just finished the exam. To check your result
      ...
      <div className={classes.formWrapper}>
        <form onSubmit={onFinish}>
          ...
          <div className={classes.buttonList}>
            ...
            <Button type="submit" disabled={!name || !emailAddress}>
              Continue
            </Button>
          </div>
        </form>
